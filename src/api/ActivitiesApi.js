...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ActivityZone', 'model/Comment', 'model/DetailedActivity', 'model/ERRORUNKNOWN', 'model/Fault', 'model/Lap', 'model/SummaryActivity', 'model/SummaryAthlete', 'model/UpdatableActivity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ActivityZone'), require('../model/Comment'), require('../model/DetailedActivity'), require('../model/ERRORUNKNOWN'), require('../model/Fault'), require('../model/Lap'), require('../model/SummaryActivity'), require('../model/SummaryAthlete'), require('../model/UpdatableActivity'));
  } else {
    // Browser globals (root is window)
    if (!root.StravaApiV3) {
      root.StravaApiV3 = {};
    }
    root.StravaApiV3.ActivitiesApi = factory(root.StravaApiV3.ApiClient, root.StravaApiV3.ActivityZone, root.StravaApiV3.Comment, root.StravaApiV3.DetailedActivity, root.StravaApiV3.ERRORUNKNOWN, root.StravaApiV3.Fault, root.StravaApiV3.Lap, root.StravaApiV3.SummaryActivity, root.StravaApiV3.SummaryAthlete, root.StravaApiV3.UpdatableActivity);
  }
}(this, function(ApiClient, ActivityZone, Comment, DetailedActivity, ERRORUNKNOWN, Fault, Lap, SummaryActivity, SummaryAthlete, UpdatableActivity) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ERRORUNKNOWN} startDateLocal ISO 8601 formatted date time.
     ...
     * @param {module:model/ERRORUNKNOWN} opts.photoIds List of native photo ids to attach to the activity.
